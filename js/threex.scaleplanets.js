...
THREEx.Planets.createJupiter	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'images/jupiter2.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'images/jupiter_bump_1.jpg'),
		bumpScale: 0.002,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
...
THREEx.Planets.createJupiterCloudAnimation	= function(){
	...
	var geometry	= new THREE.SphereGeometry(0.515, 32, 32)
...
THREEx.Planets.createJupiterCloud	= function(){
	...
	imageMap.addEventListener("load", function() {
		...
		imageTrans.src	= THREEx.Planets.baseURL+'images/jupiter_cloud_map_1a_1024x512.jpg';
	}, false);
	imageMap.src	= THREEx.Planets.baseURL+'images/jupiter_cloud_map_color_1a_1024x512.jpg';
...
THREEx.Planets.createCeres	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'images/ceresmap1k.jpg'),
		//bumpMap	: THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'images/plutobump1k.jpg'),
		//bumpScale: 0.005,
	})
	var mesh	= new THREE.Mesh(geometry, material)
